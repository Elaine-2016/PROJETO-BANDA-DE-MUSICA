...
* **Painel de Administração:** Consulta em tempo real do estado das vendas, bilhetes disponíveis e receitas geradas por evento através de Views MySQL.
...
1. Clone este repositório: `git clone https://github.com/Elaine-2016/nome-do-repositorio.git`
